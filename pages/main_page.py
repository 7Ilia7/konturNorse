...
class MainPage(BaseObject, Assertion):
    ...
    def check_in_data_package_menu(self):
        self.assertion_equal('Data Packages', self.get_text(MainPageLocators.DATA_PACKAGE_TXT))
    ...
    def check_that_we_not_have_any_project(self):
        self.assertion_equal('Click on the button below to get started', self.get_text(MainPageLocators.TEXT_WHEN_WE_HAVE_ANY_PROJECT))
